...
module.exports = {
    ...
    async editOneTeam(teamId, teamName, teamVictory, teamDefeat, teamContinent, playerTop, PlayerMid, PlayerAdc, PlayerSupport, playerJungle) {
        try {
            conn = await pool.getConnection();
            ...
            const okPacket = await conn.query(sql, [teamName, teamVictory, teamDefeat, teamContinent, playerTop, PlayerMid, PlayerAdc, PlayerSupport, playerJungle, teamId]);
            conn.end();
    ...
    /*
      ...
      async getAllBrands() { 
        // ?TODO? move to brands.repository.js
        try {
          conn = await pool.getConnection();
